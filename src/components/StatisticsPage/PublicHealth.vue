            ...
            <AnimationBox >
                ...
                <div class="tabHead" v-if="show" >
                    <a href="javascript:void(0)"
                       v-for="item in tabs"
                       :key="item.class"
                       :class="['tabLinkitem',{ active: selected === item.class }]"
...
<script>
    import first from '../sidebar/sidebar.vue';
    import second from '../sidebar/text.vue';
